"""
Aluno: Peterson de Azevedo - Curso: Tecnologia em Inteligencia Artificial Aplicada
Materia: Raciocinio Computacional (11100010563_20221_02)
PROJETO DA DISCIPLINA: Implementacao de jogo digital
"""
import random
...
def inicio():
    ...
    print("\tPeterson de Azevedo")
    print("\tRaciocínio Computacional (11100010563_20221_02)")
    print("\tTecnologia em Inteligencia Artificial Aplicada")
    print(monta_rodape_secao())
    print("")
